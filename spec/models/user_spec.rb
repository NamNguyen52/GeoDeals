...
describe 'User' do
  describe "#create" do
    it 'should have a valid first name' do
      user = User.new(first_name: '!@#$%^&*()1234567890', last_name: 'Smilansky', password: 'testpassword',
    ...
    it 'should have an email beginning with characters and/or integers only' do
      user = User.create(first_name: 'Matthew', last_name: 'Smillansky', password: 'testpassword',
